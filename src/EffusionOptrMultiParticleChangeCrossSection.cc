...
// ********************************************************************
//
/// \file GB01/src/EffusionOptrMultiParticleChangeCrossSection.cc
/// \brief Implementation of the EffusionOptrMultiParticleChangeCrossSection class
//
...
EffusionOptrMultiParticleChangeCrossSection::EffusionOptrMultiParticleChangeCrossSection()
: G4VBiasingOperator("EffusionXSchange-Many"){}

//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......

void EffusionOptrMultiParticleChangeCrossSection::AddParticle(G4String particleName)
{
    ...
    if ( particle == 0 )
    {
        ...
        G4Exception("EffusionOptrMultiParticleChangeCrossSection::AddParticle(...)",
                    "exGB01.02",
                    JustWarning,
                    ed);
        return;
    ...
    EffusionOptrChangeCrossSection* optr = new EffusionOptrChangeCrossSection(particleName);
...
G4VBiasingOperation*
EffusionOptrMultiParticleChangeCrossSection::
...
void EffusionOptrMultiParticleChangeCrossSection::StartTracking( const G4Track* track )
{
    ...
    if(track->GetParticleDefinition()->GetParticleType()=="nucleus" &&
       track->GetParticleDefinition()->GetParticleSubType()=="generic"){
        definition = G4GenericIon::Definition();
    }
    std::map < const G4ParticleDefinition*, EffusionOptrChangeCrossSection* > :: iterator it = fBOptrForParticle.find( definition );
    fCurrentOperator = 0;
