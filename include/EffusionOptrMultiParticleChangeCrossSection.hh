...
// ********************************************************************
//
/// \file GB01/include/EffusionOptrMultiParticleChangeCrossSection.hh
/// \brief Definition of the EffusionOptrMultiParticleChangeCrossSection class
//
// $Id: $
//-----------------------------------------------------------------
//
...
//        In the present case, the EffusionOptrChangeCrossSection
...
#ifndef EffusionOptrMultiParticleChangeCrossSection_hh
#define EffusionOptrMultiParticleChangeCrossSection_hh 1

#include "G4VBiasingOperator.hh"
class EffusionOptrChangeCrossSection;
class G4ParticleDefinition;

#include <map>

class EffusionOptrMultiParticleChangeCrossSection : public G4VBiasingOperator {
public:
  EffusionOptrMultiParticleChangeCrossSection();
  virtual ~EffusionOptrMultiParticleChangeCrossSection() {}
...
private:
  ...
  std::map < const G4ParticleDefinition*, 
             EffusionOptrChangeCrossSection* >    fBOptrForParticle;
  std::vector < const G4ParticleDefinition* >   fParticlesToBias;
  EffusionOptrChangeCrossSection*                  fCurrentOperator;
