...
// ********************************************************************
//
/// \file GB01/include/EffusionOptrChangeCrossSection.hh
/// \brief Definition of the EffusionOptrChangeCrossSection class
//
// $Id: $
//---------------------------------------------------------------
//
// EffusionOptrChangeCrossSection
//
// Class Description:
...
#ifndef EffusionOptrChangeCrossSection_hh
#define EffusionOptrChangeCrossSection_hh 1
...
class EffusionOptrChangeCrossSection : public G4VBiasingOperator {
public:
  // ------------------------------------------------------------
  // -- Constructor: takes the name of the particle type to bias:
  // ------------------------------------------------------------
  EffusionOptrChangeCrossSection(G4String particleToBias, G4String name = "ChangeXS");
  virtual ~EffusionOptrChangeCrossSection();
